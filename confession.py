...
button_text_list = [ '房产证给你', '我妈会游泳', '我会修电脑', '我会写代码', '每天哄你开心', '带你吃好吃的']


# 按钮
def button(text, x, y, w, h, color, screen):
    pygame.draw.rect(screen, color, (x, y, w, h))
    font = pygame.font.Font('./imgs/simkai.ttf', 20)
...
def title(text, screen, scale, color=(0, 0, 0)):
    font = pygame.font.Font('./imgs/simkai.ttf', WIDTH // (len(text) * 2))
...
def show_like_interface(text, screen, color=(255, 0, 0)):
    ...
    font = pygame.font.Font('./imgs/simkai.ttf', WIDTH // (len(text)))
    textRender = font.render(text, True, color)
    textRect = textRender.get_rect()
...
def main():
    ...
    while running:
        ...
        # 加载图片
        img = pygame.image.load("./imgs/loveyou.jpg")
